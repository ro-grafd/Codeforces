...
long long f(long long x, ll l, ll r){
	return r/x-(l-1)/x;
}
void solve()
{
    ll l, r; cin >> l >> r;
    // log (1e18) ~ 60
    cout << f(1, l, r) -f(2,l,r) -f(3,l,r) - f(5,l,r) - f(7,l,r) 
    + f(6,l, r) + f(10,l, r) + f(14,l, r)+ f(15,l, r)+ f(21,l, r)+ f(35, l, r)
    - f(30,l, r)- f(42,l, r)- f(105,l, r)- f(70, l, r)
    + f(210, l, r) << nline;
}
