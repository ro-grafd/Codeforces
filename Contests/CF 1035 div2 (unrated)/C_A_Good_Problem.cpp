...
void solve()
{
    ...
    // ANDing more will get LHS towards zero and ideally we'd want it to be "0" coz
    // RHS would be anyway zero
    // so if n / 2 combination can be achieved zeros then answer exist
    if(n == 2)
    {
        cout << -1 << nline;
        return;
